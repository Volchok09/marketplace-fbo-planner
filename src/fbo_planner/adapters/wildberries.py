...
def read_sample_csv(path: Path) -> list[DemandSignal]:
    """Read a normalized Wildberries-style CSV export.

    Real seller exports are intentionally not committed to this repository.
    This helper expects the public sample column names used in examples.
    """
